...
!function(window, undefined) {
    ...
    function init() {
        FP.helpers.adjustImagePositioning($(el_fullScreenImage)), Modernizr.touch ? initFirstFrame() : downloadAmbients().then(initFirstFrame);
    }
    function resolveFirstFrame() {
        return $(".section-intro").addClass("active"), initVideo(), playVideo("#intro"), 
    ...
    function bindScrollButtons() {
        $("#section-intro__btn").click(function(e) {
            ...
            $(el_fullScreenVideo).fadeOut(1200, function() {
                myPlayer.loop(!1), myPlayer.src(""), setTimeout(function() {
    ...
    var myPlayer, el_fullScreenImage = ".full-screen-image", el_fullScreenVideo = "#mainVideo", el_sectionContainer = ".wrapper", distanceScrolled = 0, scrollDirection = 1, playlistCount = 0, ambients = [], selectedVideos = [];
    return {
        init: init,
        myPlayer: myPlayer
    };
