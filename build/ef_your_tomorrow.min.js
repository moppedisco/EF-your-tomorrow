...
function($) {
    ...
    function init() {
        if (FP.helpers.adjustImagePositioning($(el_fullScreenImage)), Modernizr.touch) animateIntro(), 
        bindScrollButtons(), FP.helpers.bindWindowResize(el_fullScreenImage, el_fullScreenVideo); else {
            downloadAmbients(), animateIntro();
            for (var i = 0; 6 > i; i++) {
    ...
    function resetSection() {
        Modernizr.video && !Modernizr.touch;
    }
    ...
    function bindScrollButtons() {
        $(".article-start__btn").click(function(e) {
            ...
            selectedVideos.push(videoUrl), downloadVids(videoUrl, selectedVideos.indexOf(videoUrl)), 
            console.log(selectedVideos), $(".subtitles").append("<li>" + text + "</li>"), setTimeout(function() {
            ...
            $(el_fullScreenVideo).fadeOut(2500, function() {
                myPlayer.loop(!1), myPlayer.src(""), goToSection(1, "#playingPlaylist", !1, function() {
                    Modernizr.touch ? console.log("mobile playlist") : (console.log("desktop playlist"), 
                    playPlaylist());
                });
            }), e.preventDefault();
    ...
    function playPlaylistIndex(index) {
        ...
        }, 3e3), console.log(selectedVideos[index]), myPlayer.src(selectedVideos[index]), 
        myPlayer.play(), playlistCount++;
    }
    var myAudioPlayer, myPlayer, el_fullScreenImage = ".full-screen-image", el_fullScreenVideo = "#mainVideo", el_sectionContainer = ".wrapper", $mainAudio = $("#mainAudio"), distanceScrolled = 0, scrollDirection = 1, playlistCount = 0, ambients = [], videoPromises = [], selectedVideos = [];
