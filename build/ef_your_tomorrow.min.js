...
function($) {
    ...
    function init() {
        ...
        bindScrollButtons(), FP.helpers.bindWindowResize(el_fullScreenImage, el_fullScreenVideo); else {
            ...
            namePlaceholder(), initVideo(function() {
                playVideo("#start");
    ...
    function bindScrollButtons() {
        $(".article-start__btn").click(function(e) {
            ...
            if ($(this).siblings().unbind("click"), $(this).hasClass("active")) return !1;
            $(this).addClass("active");
            var target = $(this).attr("href"), videoUrl = $(this).attr("data-video"), text = $(this).attr("data-text");
            console.log(target), selectedVideos.push(videoUrl), downloadVids(videoUrl, selectedVideos.indexOf(videoUrl)), 
            ...
            $(".full-screen-section.active .button--play").addClass("animated fadeOut"), $(el_fullScreenVideo).fadeOut(2500, function() {
    ...
    function initAudio() {
        $mainAudioCtrl.show(), $mainAudio[0].volume = 1, $mainAudio[0].play(), $("#volumeCtrl").on("change", function() {
            var val = $(this).val();
    ...
    function playPlaylist() {
        ...
        playPlaylistIndex(playlistCount), $("#mainVideo video").bind("ended", function() {
            playlistCount < selectedVideos.length ? (console.log(playlistCount), playPlaylistIndex(playlistCount)) : ($mainAudio.animate({
                volume: 0
            }, 5e3, function() {
                $mainAudio[0].pause();
            }), $(".input-share").click(function() {
                $(this).select();
            }), playlistCount = 0, $(".subtitles,#mainVideo").hide().promise().done(function() {
    ...
    var myAudioPlayer, myPlayer, el_fullScreenImage = ".full-screen-image", el_fullScreenVideo = "#mainVideo", el_sectionContainer = ".wrapper", $mainAudio = $("#mainAudio"), $mainAudioCtrl = $("#volumeCtrl"), distanceScrolled = 0, scrollDirection = 1, playlistCount = 0, ambients = [], videoPromises = [], selectedVideos = [];
