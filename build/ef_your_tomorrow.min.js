...
function($) {
    ...
    function bindActionButtons() {
        $(".article-start__btn").click(function(e) {
            ...
            Modernizr.touch || YT.app.moveBGvideo(1), YT.app.goToSection(1, target, !0), e.preventDefault();
            ...
            setTimeout(function() {
                Modernizr.touch || YT.app.moveBGvideo(1), YT.app.goToSection(1, target, !0);
    ...
    function init() {
        downloadAmbients(), initAudio(), bindActionButtons(), bindWindowResize($fullScreenImage, el_fullScreenVideo), 
    ...
    var myPlayer, $fullScreenImage = $(".full-screen-image"), $fullScreenSection = $(".full-screen-section"), $sectionContainer = $(".wrapper"), $mainAudio = $("#mainAudio"), $mainAudioCtrl = $("#volumeCtrl"), el_fullScreenVideo = "#mainVideo", distanceScrolled = 0, ambients = [], videoPromises = [], selectedCatogories = [], playlist = [], playlistCount = 0, mediaAspect = 16 / 9, $window = $(window);
