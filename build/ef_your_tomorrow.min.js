...
!function(window, undefined) {
    ...
    Backbone.VERSION = "1.1.1", Backbone.$ = $, Backbone.noConflict = function() {
    ...
    function init() {
        new YOUR_TMR.AppView();
    }
    window.YOUR_TMR = {
        init: init
    };
}(window), YOUR_TMR.AppView = Backbone.View.extend({
    el: $(".body"),
    isAnimating: !1,
    currentPosition: 0,
    pxLoader: new PxLoader(),
    initialize: function() {
        this.model = new YOUR_TMR.AppViewModel(), this.listenTo(this.model, "change", this.loadResource), 
        this.render();
    },
    events: function() {
    ...
    nextSection: function() {
        console.log("scroll bitches"), $el.transition({
            y: currentPosition + "%",
    ...
    initialize: function(options) {
        this.parent = options.parent, this.model.set("videoBgUrl", this.el.dataset.video).set("isActive", !1), 
        this.render();
    },
    events: function() {
        var _this = this;
    ...
    addCategoryItem: function(video) {
        ...
        tempPlaylist.push(video), this.parent.model.set("playlist", tempPlaylist), this.parent.model.trigger("change");
    },
    render: function() {
        return this.$el.html(), this;
    }
