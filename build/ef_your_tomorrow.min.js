...
!function(window, undefined) {
    ...
    function bindScrollButtons() {
        $("#section-intro__btn").click(function(e) {
            ...
            resetSection(), animatedIntroSection(), setTimeout(function() {
                moveBGvideo(scrollDirection), scrollToDiv(scrollDirection, target);
    ...
    function loadPlaylist() {
        $("#mainVideo").show(), $("#mainVideo video").bind("ended", function() {
            count < selectedVideos.length ? playPlaylist(count) : (console.log("ENDED"), $(".section-last h1").addClass("animated fadeInDown"), 
            $(".section-last h2").addClass("animated fadeInUp"));
        }), playPlaylist(count);
    }
    function playPlaylist(index) {
        myPlayer.src(selectedVideos[index]), myPlayer.play(), count++;
    }
