...
!function(window, undefined) {
    ...
    function init() {
        new YOUR_TMR.WrapperView();
    }
    window.YOUR_TMR = {
        init: init
    };
}(window), YOUR_TMR.WrapperView = Backbone.View.extend({
    el: $(".body"),
    initialize: function() {
        this.model = new YOUR_TMR.myModel(), _.bindAll(this, "render"), this.render();
    },
    addToPlaylist: function() {},
    render: function() {
        this.$el.empty(), this.siteLoader = new YOUR_TMR.SiteLoader(), this.$el.append(this.siteLoader.$el), 
        this.siteLoader.isLoaded && (this.introView = new YOUR_TMR.IntroView(), this.categoryView = new YOUR_TMR.CategoryView(), 
        this.$el.append(this.introView.$el).append(this.categoryView.$el));
    }
