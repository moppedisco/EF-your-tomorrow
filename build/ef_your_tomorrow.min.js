...
!function(window, undefined) {
    ...
    t.prototype = new Error(), t.prototype.name = "InvalidCharacterError", e.btoa || (e.btoa = function(e) {
        ...
        a++ % 4) ? c += String.fromCharCode(255 & o >> (-2 * a & 6)) : 0) n = r.indexOf(n);
        return c;
    });
}(), function(global) {
...
function($) {
    ...
    function init() {
        YT.app.init(), YT.createVideoPage.init();
    }
    function share() {
        YT.app.init(), YT.sharePage.init();
    }
    window.YT = {
        init: init,
        share: share
    };
}(window), YT.createVideoPage = function(window) {
    function init() {
        Modernizr.touch ? (console.log("YT.createVideoPage mobile"), welcomeScreen(function() {
            console.log("welcome done");
        }), bindMobileButtons()) : (welcomeScreen(function() {
            Modernizr.audio && (YT.app.myAudioPlayer()[0].play(), YT.app.myAudioPlayer().animate({
                volume: .5
            }, 1500), $("#mep_0").fadeIn(500));
        }), YT.app.initVideo(function() {
            YT.app.playVideo("#start");
        }), bindActionButtons(), shareInput(), downloadVideos(6), $.when.apply(null, YT.app.videoPromises).done(function() {
            setTimeout(function() {
    ...
    function bindMobileButtons() {
        $(".article-start__btn").click(function(e) {
            $(this).attr("href");
            return $(this).hasClass("active") ? !1 : ($(this).addClass("active"), YT.app.goToSection(1, !0), 
            void e.preventDefault());
        }), $(".link-list a").click(function(e) {
            {
                var ulElement = ($(this).attr("href"), $(this).closest("ul"));
                $(this).closest("li").index();
            }
            if ($(this).hasClass("active")) return !1;
            if ($(this).addClass("active"), YT.app.selectedCatogories[getNumberOfCategory(ulElement)] = getNumberOfOption($(this), ulElement), 
            console.log(YT.app.selectedCatogories), setTimeout(function() {
                YT.app.goToSection(1, !0);
            }, 200), 4 === YT.app.active_section) {
                var mobileVideoUrl = YT.app.loadMobileVideo();
                console.log(YT.app.mobileVideoPlayer), YT.app.mobileVideoPlayer.src = mobileVideoUrl, 
    ...
    function bindActionButtons() {
        $(".article-start__btn").click(function(e) {
            $(this).attr("href");
            return $(this).hasClass("active") ? !1 : ("undefined" != typeof ga && ga("send", "event", "Button - Start here", "click", "Clicked Start here"), 
            $(this).addClass("active"), YT.app.moveBGvideo(1), YT.app.goToSection(1, !0), void e.preventDefault());
        }), $(".link-list a").click(function(e) {
            var videoUrl = ($(this).attr("href"), $(this).attr("data-video")), text_button = $.trim($(this).text()), text = $(this).attr("data-text"), ulElement = $(this).closest("ul"), liElement = $(this).closest("li").index(), textPosition = $(this).attr("data-position");
            if ($(this).hasClass("active")) return !1;
            if ("undefined" != typeof ga && ga("send", "event", "Button - Category" + YT.app.active_section, "click", "Clicked index: " + liElement + " - " + text), 
            $(this).addClass("active"), YT.app.playlist.push(videoUrl), YT.app.selectedCatogories[getNumberOfCategory(ulElement)] = getNumberOfOption($(this), ulElement), 
            console.log(YT.app.selectedCatogories), YT.app.resolveVideos(videoUrl, YT.app.playlist.indexOf(videoUrl)), 
            $(".subtitles").append("<li>" + text + "</li>"), $(".subtitles li:last-child").addClass(textPosition), 
            $("section.active").hasClass("language-category")) {
                var string = $(".full-screen-section:eq(" + (YT.app.active_section + 1) + ") h2").text();
                string = string.replace("$lang", $.trim(text_button)), $(".full-screen-section:eq(" + (YT.app.active_section + 1) + ")").find("h2").html(string);
            }
            setTimeout(function() {
                YT.app.moveBGvideo(1), YT.app.goToSection(1, !0, function() {
                    YT.app.active_section === YT.app.pageSections.length - 3;
                });
            }, 200), e.preventDefault();
        });
    }
    function welcomeScreen(callback) {
        $("#intromessage li:eq(0)").fadeIn(800), setTimeout(function() {
            $("#intromessage li:eq(1)").fadeIn(function() {
                setTimeout(function() {
                    showFirstScreen(), callback();
                }, 2e3);
            });
        }, 3e3);
    }
    function showFirstScreen() {
        $(".article-start__title,.article-start__line").transition({
            opacity: 1
        }), $(".article-loading").fadeOut(function() {
            setTimeout(function() {
                $(".article-start__desc,.article-start__btn").transition({
                    opacity: 1
                });
            }, 1e3);
        });
    ...
    function shareInput() {
        $(".input-share").on({
            click: function() {
                $(this).select(), "undefined" != typeof ga && ga("send", "event", "Button - URL field", "click", "Clicked share your video field");
            },
            copy: function() {
                "undefined" != typeof ga && ga("send", "event", "Button - URL field", "click", "Copyied URL field");
            }
        });
    }
...
}(window), YT.sharePage = function(window) {
    function init() {
        downloadVideos(data.Videos), YT.app.initVideo(function() {
            YT.app.playVideo("#playPlaylist");
        }), $.when.apply(null, YT.app.videoPromises).done(function() {
            $(".button--play").addClass("loaded"), $("#mep_0").fadeIn(500);
        });
    }
    function downloadVideos(data) {
        for (var i = 0; i < data.length; i++) {
            var categoryPromise = $.Deferred();
            YT.app.videoPromises.push(categoryPromise), $(".subtitles").append("<li class='" + data[i].Position + "''>" + data[i].Title + "</li>"), 
            YT.app.playlist.push(data[i].Url), YT.app.resolveVideos(data[i].Url, i);
        }
    }
...
}(window), YT.app = function(window) {
    function init() {
        createPageSections(), Modernizr.touch ? (console.log("YT.app mobile"), createMobileVideoPlayer(), 
        mobileFullscreenBG()) : (adjustImagePositioning($fullScreenImage), downloadAmbients(), 
        initAudio(), bindActionButtons(), bindWindowResize($fullScreenImage, el_fullScreenVideo));
    }
    function mobileFullscreenBG() {
        $(".full-screen-image").each(function() {
            var src = $(this).attr("src");
            $(this).parents(".full-screen-section").css({
                "background-image": "url(" + src + ")"
            }), $(this).remove();
        }), $(".button--play").click(function(e) {
            goToSection(1, !0, function() {
                YT.app.mobileVideoPlayer.play(), $("#playingPlaylist video")[0].webkitEnterFullScreen();
            }), e.preventDefault();
        });
    }
    function createMobileVideoPlayer() {
        YT.app.mobileVideoPlayer = document.createElement("video"), YT.app.mobileVideoPlayer.id = "mobilePlayer", 
        YT.app.mobileVideoPlayer.controls = !0, $("#playingPlaylist .vert-align__inner").append(YT.app.mobileVideoPlayer), 
        YT.app.mobileVideoPlayer.addEventListener("loadstart", function() {
            console.log("loaded"), console.log($("#playPlaylist video"));
        }, !1), YT.app.mobileVideoPlayer.addEventListener("ended", function() {
            console.log("ended"), goToSection(1, !0);
        }, !1), YT.app.mobileVideoPlayer.addEventListener("play", function() {
            console.log("playing");
        }, !1), YT.app.mobileVideoPlayer.addEventListener("webkitendfullscreen", function() {
            console.log("window closed"), goToSection(1, !1);
        }, !1), YT.app.mobileVideoPlayer.addEventListener("pause", function() {
            console.log("paused");
        }, !1);
    }
    function initMobileVideo() {
        YT.app.mobileVideoPlayer.play(), 4 !== YT.app.mobileVideoPlayer.readyState && (YT.app.mobileVideoPlayer.addEventListener("canplaythrough", onCanPlayMobileVideo, !1), 
        YT.app.mobileVideoPlayer.addEventListener("load", onCanPlayMobileVideo, !1), setTimeout(function() {
            YT.app.mobileVideoPlayer.pause();
        }, 1));
    }
    function onCanPlayMobileVideo() {
        YT.app.mobileVideoPlayer.removeEventListener("canplaythrough", onCanPlayMobileVideo, !1), 
        YT.app.mobileVideoPlayer.removeEventListener("load", onCanPlayMobileVideo, !1);
    }
    function loadMobileVideo() {
        var string = "";
        return $.each(selectedCatogories, function(index, value) {
            category = String.fromCharCode(65 + index), string += category + (value + 1);
        }), console.log(string), console.log(mobileVideos[string]), mobileVideos[string];
    }
    ...
    function playlistIntro(callback) {
        if (Modernizr.touch) $(".full-screen-section.active .button--play").fadeOut(2500), 
        $(".full-screen-section.active .full-screen-image").fadeOut(2500, function() {
            ...
            song = YT.app.myAudioPlayer().attr("data-playlist-music"), YT.app.myAudioPlayer().animate({
                volume: 0
            }, 2500), Modernizr.cssanimations ? $("#mainVideo").fadeOut(2500, function() {
                YT.app.myAudioPlayer()[0].setAttribute("src", song), YT.app.myAudioPlayer()[0].setAttribute("volume", volume), 
                YT.app.myAudioPlayer()[0].setAttribute("loop", !1), callback();
            }) : $(".full-screen-section.active .full-screen-image").fadeOut(2500, function() {
                YT.app.myAudioPlayer()[0].setAttribute("src", song), YT.app.myAudioPlayer()[0].setAttribute("volume", volume), 
                YT.app.myAudioPlayer()[0].setAttribute("loop", !1), callback();
            });
    ...
    function resolveAmbients(resolve) {
        ...
        }), loader.addProgressListener(function() {}), loader.addCompletionListener(function() {
            resolve();
        }), loader.start();
    }
    ...
    function initVideo(callback) {
        Modernizr.video.h264 && !Modernizr.touch && (myPlayer = $(el_fullScreenVideo)[0], 
        myPlayer.setAttribute("loop", "true"), adjustVideoPositioning(el_fullScreenVideo), 
        callback());
    }
    function playVideo(target) {
        if (!Modernizr.touch) {
            var videoToPlay = $(target).attr("data-video"), poster = $(target).find(".full-screen-image").attr("src");
            myPlayer.setAttribute("poster", poster), myPlayer.setAttribute("src", videoToPlay), 
            myPlayer.play(), Modernizr.video && Modernizr.cssanimations && $(target).find(".full-screen-image").fadeOut();
        }
    }
    function bindActionButtons() {
        $(".button--play").click(function(e) {
            if ("undefined" != typeof ga && ga("send", "event", "Button - Play", "click", "Clicked Play playlist"), 
            $(this).hasClass("active")) return !1;
            $(this).addClass("active"), playlistIntro(function() {
                myPlayer.removeAttribute("loop"), myPlayer.setAttribute("src", ""), goToSection(1, !1, function() {
                    playPlaylist();
                });
            });
            ...
            mailURL = "mailto:?subject=This is my tomorrow&body=" + uniqueURL, $(".input-share[type='text']").attr("value", uniqueURL), 
            $(".icon--twitter").attr("href", twitterURL), $(".icon--mail").attr("href", mailURL), 
            e.preventDefault();
        });
    }
    function goToSection(steps, animate, callback) {
        distanceScrolled -= 100 * steps;
        var current = pageSections[YT.app.active_section].id, target = pageSections[YT.app.active_section + steps].id;
        YT.app.active_section = YT.app.active_section + steps, animate && Modernizr.cssanimations ? $sectionContainer.transition({
            y: distanceScrolled + "%",
            easing: "custom-ease",
            duration: 800
        }, function() {
            $("#" + current).removeClass("active"), $("#" + target).addClass("active"), $(el_fullScreenVideo).css({
                transform: "translate(0, 0)"
            }), playVideo("#" + target), callback && "function" == typeof callback && callback();
        }) : ($("#" + current).removeClass("active"), $("#" + target).addClass("active"), 
        $(el_fullScreenVideo).css({
            transform: "translate(0, 0)"
        }), $sectionContainer.css($("html").hasClass("ie8") ? {
    ...
    function createPrePlayer($myVideo) {
        ...
        prePlayer = $preVideo[0], prePlayer.setAttribute("id", "preVideo"), $myVideo.after(prePlayer);
    }
    function preparePlayListPlayer() {
        var $myVideo = $(el_fullScreenVideo);
        $myVideo.attr("poster", ""), createPrePlayer($myVideo), videoPlayers = [ myPlayer, prePlayer ], 
        myPlayer.style.zIndex = 1, prePlayer.style.zIndex = 0, myPlayer.style.display = "inline-block", 
        prePlayer.style.display = "inline-block", myPlayer.setAttribute("src", ""), $myVideo.show();
    }
    function playPlaylist() {
        playlistCount = 0, preparePlayListPlayer(), playPlaylistIndex(playlistCount), myAudioPlayer[0].volume = myAudioPlayer[0].volume + .1, 
        myAudioPlayer[0].play(), $(".videoPlayer").bind("ended", function() {
            playlistCount < playlist.length ? playPlaylistIndex(playlistCount) : ($mainAudio.animate({
                volume: 0
            }, 5e3, function() {
                myAudioPlayer[0].pause(), myAudioPlayer[0].currentTime = 0;
            }), $(".subtitles,#mainVideo").hide(), goToSection(1, !1, function() {
                setTimeout(function() {
                    share();
                }, 4e3);
            }), $(".videoPlayer").unbind(), $(prePlayer).remove());
        });
    }
    function swapVideoPlayers() {
        var videoPlayer = videoPlayers[0];
        videoPlayers[0] = videoPlayers[1], videoPlayers[1] = videoPlayer;
    }
    function playPlaylistIndex(index) {
        ...
        var curVideoPlayer = videoPlayers[0], preVideoPlayer = videoPlayers[1];
        curVideoPlayer.style.zIndex = 1, curVideoPlayer.getAttribute("src") || curVideoPlayer.setAttribute("src", playlist[index]), 
        myPlayer = curVideoPlayer, curVideoPlayer.play(), playlist[index + 1] && (preVideoPlayer.style.zIndex = 0, 
        preVideoPlayer.setAttribute("src", playlist[index + 1])), playlistCount++, swapVideoPlayers();
    }
    ...
    var myAudioPlayer, myPlayer, prePlayer, mobileVideoPlayer, $fullScreenImage = $(".full-screen-image"), $fullScreenSection = $(".full-screen-section"), $sectionContainer = $(".wrapper"), $mainAudio = $("#mainAudio"), el_fullScreenVideo = "#mainVideo", distanceScrolled = 0, videoPlayers = [], ambients = [], videoPromises = [], selectedCatogories = [], playlist = [], playlistCount = 0, mediaAspect = 16 / 9, pageSections = [], active_section = 0, $window = $(window);
    ...
    var getShareLink = function(selectedCatogories) {
        ...
        return console.log(serializedString), Modernizr.csstransitions ? window.location.host + window.Settings.VideoPageUrl + "?id=" + window.btoa(escape(serializedString)) : void 0;
    };
    return {
        init: init,
...
}(window), Array.prototype.indexOf || (Array.prototype.indexOf = function(elt) {
