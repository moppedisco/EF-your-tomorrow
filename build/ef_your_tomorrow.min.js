...
!function(window, undefined) {
    ...
    function init() {
        adjustImagePositioning($fullScreenImage), $(".section-intro").addClass("active"), 
        bindScrollButtons(), bindWindowResize(), loadComplete(), loadProgressListener();
    }
    ...
    function loadComplete() {
        loader.addCompletionListener(function() {
            console.log("LOADED"), $(".loading-videos").hide(), $(".button--play").css("visibility", "visible");
        });
    }
    function initVideo() {
        videojs("mainVideo").ready(function() {
            myPlayer = this, myPlayer.loop(!1), console.log(myPlayer);
    ...
    function bindScrollButtons() {
        $("#section-intro__btn").click(function(e) {
            ...
            selectedVideos.push(videoUrl), addLoadResources(videoUrl, "video"), "#playPlaylist" === target && loader.start(), 
            $(".subtitles").append("<li>" + text + "</li>"), setTimeout(function() {
                Modernizr.touch || moveBGvideo(scrollDirection), scrollToDiv(scrollDirection, target);
    ...
    function loadPlaylist() {
        $(".full-screen-section.active .mega").hide(), $("#mainVideo").show(), scrollToDiv(scrollDirection, "#last"), 
        $("#mainVideo video").bind("ended", function() {
            count < selectedVideos.length ? playPlaylist(count) : ($(".subtitles,#mainVideo").fadeOut(1200, function() {
    ...
    var myPlayer, directionPosition = 0, scrollDirection = 1, $fullScreenImage = $(".full-screen-image"), fullScreenVideo = "#mainVideo", $sectionContainer = $(".body"), $window = $(window), mediaAspect = 16 / 9, selectedVideos = [], loader = new PxLoader(), count = 0;
    return {
        init: init,
