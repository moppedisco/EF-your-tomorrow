...
!function(window, undefined) {
...
}(window), FP.app = function(window) {
    function init() {
        var loader = new PxLoader();
        adjustImagePositioning($(el_fullScreenImage)), $(el_fullScreenSection).each(function() {
            var videoUrl = $(this).attr("data-video");
            videoUrl && (ambientVideos.push(videoUrl), loader.addVideo(videoUrl));
        }), console.log(ambientVideos), loader.addProgressListener(function(e) {
            console.log(e.completedCount + " / " + e.totalCount);
        }), loader.addCompletionListener(function() {
            console.log("LOADED"), $(".section-intro").addClass("active"), initVideo(), playVideo("#intro"), 
            bindScrollButtons(), bindWindowResize();
        }), loader.start();
    }
    function initVideo() {
    ...
    function playVideo(target) {
        ...
        myPlayer.src(videoToPlay), Modernizr.video && (Modernizr.touch || $(target).find(".full-screen-image").fadeOut()), 
        myPlayer.play();
    }
    ...
    function bindScrollButtons() {
        $("#section-intro__btn").click(function(e) {
            ...
            resetSection(), animatedIntroSection(), setTimeout(function() {
                Modernizr.touch || moveBGvideo(scrollDirection), scrollToDiv(scrollDirection, target);
            ...
            initVideo(), setTimeout(function() {
                $(el_fullScreenVideo).fadeOut(1200, function() {
                    resetAmbientPlayer(), setTimeout(function() {
                        $(".full-screen-section").removeClass("active"), $("#last").addClass("active"), 
                        loadPlaylist();
                    }, 1e3);
                });
    ...
    function scrollToDiv(direction, target) {
        distanceScrolled -= 100, $(el_sectionContainer).transition({
            y: distanceScrolled + "%",
            ...
            }), Modernizr.touch || playVideo(target);
        });
    }
    ...
    function bindWindowResize() {
        $(window).resize(function() {
            adjustImagePositioning($(el_fullScreenImage)), updateSize(el_fullScreenVideo);
        });
    }
    function loadPlaylist() {
        $(".full-screen-section.active .mega").hide(), $(el_fullScreenVideo).show(), $("#mainVideo video").bind("ended", function() {
            playlistCount < selectedVideos.length ? playPlaylist(playlistCount) : ($(".subtitles,#mainVideo").fadeOut(1200, function() {
                $(".section-last img,.section-last hr").addClass("animated fadeInDown"), $(".section-last p").addClass("animated fadeInUp");
            }), console.log("ENDED"));
    ...
    function updateSize(element) {
        ...
        mediaAspect > windowAspect ? (myPlayer.width(windowH * mediaAspect).height(windowH), 
        $(element).css("top", 0).css("left", -(windowH * mediaAspect - windowW) / 2).css("height", windowH), 
        $(element + "_html5_api").css("width", windowH * mediaAspect), $(element + "_flash_api").css("width", windowH * mediaAspect).css("height", windowH)) : (myPlayer.width(windowW).height(windowW / mediaAspect), 
    ...
    var myPlayer, el_fullScreenImage = ".full-screen-image", el_fullScreenVideo = "#mainVideo", el_fullScreenSection = ".full-screen-section", el_sectionContainer = ".wrapper", $window = $(window), distanceScrolled = 0, scrollDirection = 1, mediaAspect = 16 / 9, playlistCount = 0;
    return ambientVideos = [], selectedVideos = [], {
        init: init,
