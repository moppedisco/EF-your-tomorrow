...
function($) {
    ...
    function init() {
        YT.animations.intro(), YT.app.init(), YT.helpers.init();
    }
    window.YT = {
        init: init
    };
    ...
    function outro(callback) {
        $(".full-screen-section.active .button--play").addClass("animated fadeOut"), $("#mainVideo").fadeOut(2500, function() {
            callback();
        });
    }
    function share() {
    ...
    function bindActionButtons() {
        $(".article-start__btn").click(function(e) {
            ...
            return $(this).siblings().unbind("click"), $(this).hasClass("active") ? !1 : ($(this).addClass("active"), 
            selectedVideos.push(videoUrl), resolveVideos(videoUrl, selectedVideos.indexOf(videoUrl)), 
    ...
    function playPlaylist() {
        ...
        playPlaylistIndex(playlistCount), $mainAudio[0].play(), $("#mainVideo video").bind("ended", function() {
    ...
    function playPlaylistIndex(index) {
        ...
        }, 3e3), myPlayer.src(selectedVideos[index]), myPlayer.play(), playlistCount++;
    }
    var myAudioPlayer, myPlayer, $fullScreenSection = ($(".full-screen-image"), $(".full-screen-section")), $sectionContainer = $(".wrapper"), $mainAudio = $("#mainAudio"), $mainAudioCtrl = $("#volumeCtrl"), el_fullScreenVideo = "#mainVideo", distanceScrolled = 0, scrollDirection = 1, playlistCount = 0, ambients = [], videoPromises = [], selectedVideos = [];
    ...
    var mediaAspect = 16 / 9, $window = $(window), $fullScreenImage = $(".full-screen-image"), el_fullScreenVideo = "#mainVideo";
    return {
        init: init,
