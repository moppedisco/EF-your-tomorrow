...
!function(window, undefined) {
    ...
    currentPosition: 0,
    initialize: function() {
        this.model = new YOUR_TMR.AppViewModel(), console.log(this.model), this.render();
    },
    events: function() {
        var _this = this;
    ...
    addToPlaylist: function() {
        console.log(this.model), console.log("asdasdasda");
    },
    ...
    initialize: function() {
        this.model.set("videoBgUrl", this.el.dataset.video).set("isActive", !1), this.render();
    },
    events: function() {
