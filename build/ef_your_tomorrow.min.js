...
!function(window, undefined) {
    ...
    function bindScrollButtons() {
        $("#section-intro__btn").click(function(e) {
            ...
            $(".full-screen-section.active .button--play").addClass("animated fadeOut"), initVideo(), 
            $(el_fullScreenVideo).fadeOut(1200, function() {
                resetAmbientPlayer(), setTimeout(function() {
                    $(".full-screen-section.active .mega").hide(), $(".full-screen-section").removeClass("active"), 
                    loadPlaylist();
                }, 1300);
            }), e.preventDefault();
        });
    ...
    function loadPlaylist() {
        $(el_fullScreenVideo).show(), $("#mainVideo video").bind("ended", function() {
            playlistCount < selectedVideos.length ? playPlaylist(playlistCount) : ($("#last").addClass("active"), 
            scrollToDiv(scrollDirection, "#last"), $(".subtitles,#mainVideo").fadeOut(1200, function() {
