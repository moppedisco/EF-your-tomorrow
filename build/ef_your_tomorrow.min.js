...
!function(window, undefined) {
    ...
    function init() {
        FP.helpers.adjustImagePositioning($(el_fullScreenImage)), Modernizr.touch ? initFirstFrame() : (downloadAmbients(), 
        animateIntro());
    }
    function animateIntro() {
        ...
        }, 3e3), initVideo(), playVideo("#start"), bindScrollButtons(), FP.helpers.bindWindowResize(el_fullScreenImage, el_fullScreenVideo);
    }
