...
function($) {
    ...
    function bindActionButtons() {
        $(".article-start__btn").click(function(e) {
            $(this).attr("href");
            return $(this).hasClass("active") ? !1 : (ga("send", "event", "Introbutton", "click", "Start here"), 
            $(this).addClass("active"), Modernizr.touch || YT.app.moveBGvideo(1), YT.app.goToSection(1, !0), 
            void e.preventDefault());
        }), $(".link-list a").click(function(e) {
            var videoUrl = ($(this).attr("href"), $(this).attr("data-video")), text = ($.trim($(this).text()), 
            $(this).attr("data-text")), ulElement = $(this).closest("ul");
            return $(this).hasClass("active") ? !1 : (ga("send", "event", "Category" + YT.app.active_section, "click", text), 
    ...
    function bindActionButtons() {
        $(".button--play").click(function(e) {
            ...
            return $(this).hasClass("active") ? !1 : (ga("send", "event", "Playbutton", "click", "Play your playlist"), 
            ...
            replay(function() {
                goToSection(-1, !1, function() {
                    playPlaylist(), ga("send", "event", "Replaybutton", "click", "Replay"), $(".subtitles").show(), 
                    $(".article-outromessage").show(), $(".section-last .full-screen-image").show(), 
    ...
    function playPlaylist() {
        ...
        myAudioPlayer[0].play(), $(".videoPlayer").bind("ended", function() {
            ...
            }), $(".videoPlayer").unbind("ended"), $(prePlayer).remove());
        });
    }
