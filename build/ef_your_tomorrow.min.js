...
function($) {
    ...
    function bindActionButtons() {
        $(".button--play").click(function(e) {
            ...
            return $(this).hasClass("active") ? !1 : ($(this).addClass("active"), playlistIntro(function() {
                myPlayer.loop(!1), myPlayer.src(""), goToSection(1, !1, function() {
                    playPlaylist();
                });
    ...
    function playPlaylist() {
        playlistCount = 0, $(el_fullScreenVideo).find("video").attr("poster", ""), $(el_fullScreenVideo).show(), 
        playPlaylistIndex(playlistCount), $("#mainVideo video").bind("ended", function() {
    ...
    function playPlaylistIndex(index) {
        ...
        }, 3e3), myPlayer.src(playlist[index]), myPlayer.play(), playlistCount++;
    }
    ...
    var myAudioPlayer, myPlayer, $fullScreenImage = $(".full-screen-image"), $fullScreenSection = $(".full-screen-section"), $sectionContainer = $(".wrapper"), $mainAudio = $("#mainAudio"), el_fullScreenVideo = "#mainVideo", distanceScrolled = 0, ambients = [], videoPromises = [], selectedCatogories = [], playlist = [], playlistCount = 0, mediaAspect = 16 / 9, pageSections = [], active_section = 0, $window = $(window);
