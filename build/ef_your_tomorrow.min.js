...
function($) {
    ...
    function bindActionButtons() {
        $(".article-start__btn").click(function(e) {
            $(this).attr("href");
            return $(this).hasClass("active") ? !1 : ($(this).addClass("active"), Modernizr.touch || YT.app.moveBGvideo(1), 
            YT.app.goToSection(1, !0), void e.preventDefault());
            ...
            return $(this).hasClass("active") ? !1 : ($(this).addClass("active"), YT.app.playlist.push(videoUrl), 
    ...
    function bindActionButtons() {
        $(".button--play").click(function(e) {
            ...
            return $(this).hasClass("active") ? !1 : ($(this).addClass("active"), playlistIntro(function() {
            ...
            replay(function() {
                goToSection(-1, !1, function() {
                    playPlaylist(), $(".subtitles").show(), $(".article-outromessage").show(), $(".section-last .full-screen-image").show(), 
