...
function($) {
    ...
    function init() {
        welcomeScreen(function() {
            YT.app.myAudioPlayer()[0].play(), console.log(YT.app.myAudioPlayer()), YT.app.myAudioPlayer().animate({
                volume: .5
    ...
    function playlistIntro(callback) {
        ...
        song = YT.app.myAudioPlayer().attr("data-playlist-music"), YT.app.myAudioPlayer().animate({
            volume: 0
        }, 2500), $("#mainVideo").fadeOut(2500, function() {
            YT.app.myAudioPlayer()[0].setSrc(song), YT.app.myAudioPlayer()[0].volume = volume, 
            YT.app.myAudioPlayer()[0].loop = !1, callback();
        });
    }
    ...
    function goToSection(steps, animate, callback) {
        ...
        YT.app.active_section = YT.app.active_section + steps, animate ? $sectionContainer.transition({
            y: distanceScrolled + "%",
            easing: "custom-ease",
            duration: 800
        }, function() {
