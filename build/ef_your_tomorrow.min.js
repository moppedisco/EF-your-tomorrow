...
function($) {
    ...
    function bindActionButtons() {
        $(".article-start__btn").click(function(e) {
            ...
            return $(this).hasClass("active") ? !1 : ($(this).addClass("active"), selectedVideos.push(videoUrl), 
            resolveVideos(videoUrl, selectedVideos.indexOf(videoUrl)), console.log(selectedVideos), 
