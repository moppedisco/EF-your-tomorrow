...
function($) {
    ...
    function playlistIntro(callback) {
        ...
        song = YT.app.myAudioPlayer().attr("data-playlist-music"), YT.app.myAudioPlayer().animate({
            ...
            callback(), YT.app.myAudioPlayer()[0].setSrc(song), YT.app.myAudioPlayer()[0].volume = volume, 
            YT.app.myAudioPlayer()[0].loop = !1, YT.app.myAudioPlayer()[0].play();
        });
    }
    ...
    function playPlaylist() {
        playlistCount = 0, preparePlayListPlayer(), playPlaylistIndex(playlistCount), $(".videoPlayer").bind("ended", function() {
            playlistCount < playlist.length ? playPlaylistIndex(playlistCount) : ($mainAudio.animate({
                volume: 0
            }, 5e3, function() {}), $(".subtitles,#mainVideo").hide(), goToSection(1, !1, function() {
                setTimeout(function() {
                    share();
                }, 4e3);
