...
!function(window, undefined) {
    ...
    function init() {
        if (Modernizr.touch) $(".section-intro").addClass("active"), bindScrollButtons(), 
        bindWindowResize(); else {
            {
                var loader = new PxLoader();
                loader.addVideo("vids/baseball.mp4"), loader.addVideo("vids/flipflops.mp4"), loader.addVideo("vids/surfsunset.mp4"), 
                loader.addVideo("vids/tapas.mp4"), loader.addVideo("vids/surf.mp4");
            }
            loader.addProgressListener(function(e) {
                console.log(e.completedCount + " / " + e.totalCount), $(".section-intro__loadbar").text("Loading video " + e.completedCount + " of 5");
            }), loader.addCompletionListener(function() {
                console.log("LOADED"), $(".section-intro").addClass("active"), initVideo(), playVideo("#intro"), 
                bindScrollButtons(), bindWindowResize();
            }), adjustImagePositioning($fullScreenImage), loader.start();
        }
    }
    function initVideo() {
    ...
    function playVideo(target) {
        ...
        myPlayer.src(videoToPlay), Modernizr.video || $(target).find(".full-screen-image").fadeOut(), 
        myPlayer.play();
    }
    function resetSection() {
        Modernizr.video || $(".full-screen-section:not(.active)").find(".full-screen-image").show();
    }
    ...
    function bindScrollButtons() {
        $("#section-intro__btn").click(function(e) {
            ...
            $(".full-screen-section.active .mega").addClass("animated fadeOutUp"), $(".full-screen-section.active .button--play").addClass("animated fadeOutDown"), 
            setTimeout(function() {
                $(".full-screen-section").removeClass("active"), $("#last").addClass("active"), 
                scrollToDiv(scrollDirection, "#last"), $("#mainVideo").fadeOut(1500, function() {
    ...
    function scrollToDiv(direction, target) {
        directionPosition -= 100, $sectionContainer.transition({
            y: directionPosition + "%",
            easing: "easeInOutExpo",
            duration: 800
        }, function() {
            $(".full-screen-section").removeClass("active"), $(target).addClass("active"), $("#mainVideo").css({
    ...
    function moveBGvideo(direction) {
        var move;
        move = "-1" === direction ? "100%" : "-100%", $("#mainVideo").transition({
            y: move,
            easing: "easeInOutExpo",
            duration: 800
        });
    ...
    function bindWindowResize() {
        $(window).resize(function() {
            adjustImagePositioning($fullScreenImage), updateSize(fullScreenVideo);
        });
    }
    function loadPlaylist() {
        $("#mainVideo").show(), $("#mainVideo video").bind("ended", function() {
            count < selectedVideos.length ? playPlaylist(count) : ($(".subtitles").fadeOut(), 
            console.log("ENDED"), $(".section-last h1").addClass("animated fadeInDown"), $(".section-last h2").addClass("animated fadeInUp"));
        }), playPlaylist(count);
    }
    ...
    var myPlayer, directionPosition = 0, scrollDirection = 1, $fullScreenImage = $(".full-screen-image"), fullScreenVideo = "#mainVideo", $sectionContainer = $(".body"), $window = $(window), mediaAspect = 16 / 9, selectedVideos = [ "vids/tapas.mp4", "vids/flipflops.mp4", "vids/baseball.mp4" ], count = 0;
    return {
        init: init,
