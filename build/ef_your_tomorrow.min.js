...
!function(window, undefined) {
    ...
    function animateIntro() {
        console.log("init"), $(".section-loading").addClass("active"), $("#intromessage li:eq(0)").fadeIn(), 
        setTimeout(function() {
    ...
    function resolveAmbients(resolve) {
        ...
        $(".full-screen-section").each(function(i) {
            ...
            videoUrl && (ambients.push(videoUrl), resource = new PxLoaderVideo(videoUrl), resource.__id__ = i + 1, 
            loader.add(resource));
    ...
    function initVideo() {
        console.log(Modernizr.video), videojs("mainVideo").ready(function() {
    ...
    function playVideo(target) {
        ...
        myPlayer.src(videoToPlay), myPlayer.play(), Modernizr.video && (Modernizr.touch || $(target).find(".full-screen-image").fadeOut());
    }
    ...
    function playPlaylist() {
        $(el_fullScreenVideo).show(), $("#mainVideo video").bind("ended", function() {
            playlistCount < selectedVideos.length ? playPlaylistIndex(playlistCount) : (goToSection(scrollDirection, "#last", !0), 
            $(".subtitles,#mainVideo").fadeOut(1200, function() {
                $(".inner-item--one").fadeIn(), setTimeout(function() {
