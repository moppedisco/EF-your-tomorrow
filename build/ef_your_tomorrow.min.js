...
function($) {
    ...
    function init() {
        Modernizr.touch ? window.location.href = "http://www.ef.com" : (YT.app.init(), YT.createVideoPage.init());
    }
    function share() {
    ...
    function init() {
        ...
        }), bindActionButtons(), namePlaceholder(), shareInput(), downloadVideos(6), $.when.apply(null, YT.app.videoPromises).done(function() {
            setTimeout(function() {
    ...
    function setCaret() {
        var el = $(".name-field__inputarea").get(0), center_text = $(".name-field__inputarea").text().length / 2, range = document.createRange(), sel = window.getSelection();
        range.setStart(el.childNodes[0], center_text), range.collapse(!0), sel.removeAllRanges(), 
    ...
    function bindActionButtons() {
        $(".article-start__btn").click(function(e) {
            ...
            $(this).addClass("active"), Modernizr.touch || YT.app.moveBGvideo(1), YT.app.goToSection(1, !0), 
            ...
            YT.app.resolveVideos(videoUrl, YT.app.playlist.indexOf(videoUrl)), $(".subtitles").append("<li>" + text + "</li>"), 
            $(".subtitles li:last-child").addClass(textPosition), $("section.active").hasClass("language-category")) {
            ...
            setTimeout(function() {
                YT.app.moveBGvideo(1), YT.app.goToSection(1, !0, function() {
                    YT.app.active_section === YT.app.pageSections.length - 3 && setCaret();
                });
            }, 200), e.preventDefault();
        }), $("#two .link-list a").click(function() {
    ...
    function namePlaceholder() {
        ...
        $(".name-field__inputarea").on("keypress", function(event) {
            ...
            isPlaceholder = !0, $(this).removeClass("ready"), $(".button--play").removeClass("ready")) : ($(this).addClass("ready"), 
            $(".button--play").addClass("ready"));
        }).on("focuson", function() {
            $(this).removeClass("ready"), $(".button--play").removeClass("ready");
        });
    }
    ...
    function downloadVideos(data) {
        for (var i = 0; i < data.length; i++) {
            var categoryPromise = $.Deferred();
            YT.app.videoPromises.push(categoryPromise), $(".subtitles").append("<li>" + data[i].Title + "</li>"), 
    ...
    function init() {
        createPageSections(), downloadAmbients(), initAudio(), bindActionButtons(), bindWindowResize($fullScreenImage, el_fullScreenVideo), 
    ...
    function initVideo(callback) {
        Modernizr.video.h264 && (myPlayer = $(el_fullScreenVideo)[0], myPlayer.setAttribute("loop", "true"), 
        adjustVideoPositioning(el_fullScreenVideo), callback());
    }
    ...
    function bindActionButtons() {
        $(".button--play").click(function(e) {
            ...
            if ($(".name-field__inputarea").hasClass("ready")) {
                ...
                "undefined" != typeof ga && ga("send", "event", "Name", "click", "Did enter name");
            } else "undefined" != typeof ga && ga("send", "event", "Name", "click", "Did NOT enter name");
            "undefined" != typeof ga && ga("send", "event", "Button - Play", "click", "Clicked Play playlist"), 
            ...
            replay(function() {
                goToSection(-1, !1, function() {
                    playPlaylist(), "undefined" != typeof ga && ga("send", "event", "Button - replay", "click", "Clicked replay button"), 
                    $(".subtitles").show(), $(".article-outromessage").show(), $(".section-last .full-screen-image").show(), 
                    $(".article-sharepage").show();
                });
            });
        }), $(".button--pause").click(function() {
            $(this).toggleClass("clicked"), $(this).hasClass("clicked") ? (myPlayer.pause(), 
            myAudioPlayer[0].pause()) : (myPlayer.play(), myAudioPlayer[0].play());
        });
    }
    ...
    var getShareLink = function(userName, selectedCatogories) {
        ...
        return Modernizr.csstransitions ? window.location.host + window.Settings.VideoPageUrl + "?id=" + window.btoa(escape(serializedString)) : void 0;
    };
    return {
        init: init,
