...
function($) {
    ...
    function init() {
        welcomeScreen(), YT.app.initVideo(function() {
    ...
    function welcomeScreen() {
        $(".section-loading").addClass("active"), $("#intromessage li:eq(0)").fadeIn(800), 
        setTimeout(function() {
    ...
    function initAudio() {
        $mainAudio[0].volume = .5, $("audio").mediaelementplayer({
            audioWidth: "26",
    ...
    function playPlaylist() {
        ...
        playPlaylistIndex(playlistCount), $mainAudio[0].volume = .5, $mainAudio[0].currentTime = 0, 
