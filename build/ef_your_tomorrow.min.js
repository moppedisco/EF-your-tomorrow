...
function($) {
    ...
    function init() {
        ...
        animateIntro(), initVideo(), playVideo("#start"), bindScrollButtons(), FP.helpers.bindWindowResize(el_fullScreenImage, el_fullScreenVideo));
    }
    ...
    function bindScrollButtons() {
        $(".article-start__btn").click(function(e) {
            ...
            resetSection(), Modernizr.touch || moveBGvideo(scrollDirection), goToSection(scrollDirection, target, !0), 
            e.preventDefault();
            ...
            setTimeout(function() {
                Modernizr.touch || moveBGvideo(scrollDirection), goToSection(scrollDirection, target, !0);
            ...
            $(el_fullScreenVideo).fadeOut(2500, function() {
                myPlayer.loop(!1), myPlayer.src(""), goToSection(scrollDirection, "#playingPlaylist", !1, function() {
    ...
    function goToSection(direction, target, animate, callback) {
        distanceScrolled -= 100, animate ? (console.log("animate section jump"), $(el_sectionContainer).transition({
            y: distanceScrolled + "%",
            easing: "custom-ease",
            duration: 800
        }, function() {
        ...
        })) : (console.log("dont animate section jump"), $(el_sectionContainer).css({
    ...
    function playPlaylist() {
        ...
        $("#mainVideo video").bind("ended", function() {
            playlistCount < selectedVideos.length ? playPlaylistIndex(playlistCount) : ($(".subtitles,#mainVideo").fadeOut(1200).promise().done(function() {
                goToSection(scrollDirection, "#last", !1, function() {
    ...
    function playPlaylistIndex(index) {
        $(".subtitles li").hide(), $(".subtitles li:eq(" + index + ")").show(), myPlayer.src(selectedVideos[index]), 
