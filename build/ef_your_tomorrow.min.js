...
!function(window, undefined) {
    ...
    function init() {
        ...
        loader.addProgressListener(function(e) {
            ...
            console.log("LOADED"), initVideo(), playVideo("#intro"), bindScrollButtons();
        }), loader.start(), adjustImagePositioning($fullScreenImage), bindWindowResize();
    }
    function initVideo() {
    ...
    function playVideo(target) {
        ...
        myPlayer.src(videoToPlay), $(target).find(".full-screen-image").fadeOut(), myPlayer.play();
    }
    function resetSection() {
        $(".full-screen-section:not(.active)").find(".full-screen-image").show(), $(".full-screen-section").removeClass("active");
    }
    function bindScrollButtons() {
        $(".innerLink").click(function(e) {
            var direction = $(this).attr("data-direction");
            href = $(this).attr("href"), resetSection(), "#one" === href && "1" === direction || "#intro" === href ? "#one" === href ? ($("#intro h1.mega").addClass("animated fadeOutUp"), 
            $("#btn-intro i").addClass("animated fadeOutDown"), setTimeout(function() {
                scrollToDiv(direction, href);
            }, 600)) : (console.log("up"), $("#intro h1.mega").removeClass("animated fadeOutUp"), 
            $("#btn-intro i").removeClass("animated fadeOutDown"), scrollToDiv(direction, href)) : scrollToDiv(direction, href), 
            e.preventDefault();
            ...
            setTimeout(function() {
                $("#mainVideo").fadeOut(800, function() {
                    console.log("asdasd"), resetAmbientPlayer(), loadPlaylist();
                });
    ...
    function loadPlaylist() {
        $("#mainVideo").show(), $("#mainVideo video").bind("ended", function() {
            count < selectedVideos.length ? playPlaylist(count) : alert("your selected videos has been played");
        }), playPlaylist(count);
    }
    ...
    function scrollToDiv(direction, target) {
        "1" === direction ? directionPosition -= 100 : directionPosition += 100, moveBGvideo(direction), 
        $sectionContainer.transition({
            y: directionPosition + "%",
            easing: "easeInOutExpo",
            duration: 800
        }, function() {
            $(target).addClass("active"), $("#mainVideo").css({
    ...
    var myPlayer, directionPosition = 0, $fullScreenImage = $(".full-screen-image"), fullScreenVideo = "#mainVideo", $sectionContainer = $(".body"), $window = $(window), mediaAspect = 16 / 9, selectedVideos = [ "vids/tapas.mp4", "vids/flipflops.mp4", "vids/baseball.mp4" ], count = 0;
    return {
        init: init,
