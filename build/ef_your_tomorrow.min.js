...
!function(window, undefined) {
    ...
    function playPlaylist() {
        ...
        $mainAudio[0].play(), $("#mainVideo video").bind("ended", function() {
            playlistCount < playlist.length ? (console.log(playlistCount), playPlaylistIndex(playlistCount)) : ($mainAudio.animate({
                volume: 0
            }, 5e3, function() {
                $mainAudio[0].pause();
    ...
    var myPlayer, $fullScreenImage = $(".full-screen-image"), $fullScreenSection = $(".full-screen-section"), $sectionContainer = $(".wrapper"), $mainAudio = $("#mainAudio"), $mainAudioCtrl = $("#volumeCtrl"), el_fullScreenVideo = "#mainVideo", distanceScrolled = 0, ambients = [], videoPromises = [], selectedCatogories = [], playlist = [], playlistCount = 0, mediaAspect = 16 / 9, pageSections = [], active_section = 0, $window = $(window);
