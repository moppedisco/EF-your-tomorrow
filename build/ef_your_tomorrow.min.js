...
function($) {
    ...
    function bindActionButtons() {
        $(".article-start__btn").click(function(e) {
            ...
            var target = $(this).attr("href"), videoUrl = $(this).attr("data-video"), text_button = $.trim($(this).text()), text = $(this).attr("data-text");
            if ($(this).hasClass("active")) return !1;
            $(this).addClass("active");
            var category = new categoryScene(text, text_button, videoUrl);
            YT.playlist.push(videoUrl), selectedCatogories.push(category), resolveVideos(videoUrl, YT.playlist.indexOf(videoUrl)), 
    ...
    function categoryScene(text, text_button, video) {
        this.text = text, this.text_button = text_button, this.video = video;
    }
    ...
    function playPlaylist() {
        ...
        playPlaylistIndex(YT.playlistCount), $mainAudio[0].currentTime = 0, $mainAudio[0].play(), 
