...
function($) {
    ...
    function downloadVideos(data) {
        for (var i = 0; i < data.length; i++) {
            ...
            videoPromises.push(categoryPromise), $(".subtitles").append("<li>" + data[i].Title + "</li>"), 
            YT.playlist.push(data[i].Url), YT.app.resolveVideos(data[i].Url, i);
        }
    }
    var data = window.Settings.PlayList, videoPromises = [];
    return {
        init: init
    };
