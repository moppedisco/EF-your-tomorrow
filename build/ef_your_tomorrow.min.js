...
!function(window, undefined) {
    ...
    el: $(".body"),
    initialize: function() {
        this.introView = new YOUR_TMR.IntroView(), this.categoryView1 = new YOUR_TMR.CategoryView({
            el: "#one"
    ...
    render: function() {
        this.$el.empty(), this.$el.append(this.introView.$el), this.introView.isLoaded && (this.playlistModel = new YOUR_TMR.PlaylistModel(), 
        this.$el.append(this.categoryView1.$el).append(this.categoryView2.$el).append(this.categoryView3.$el).append(this.categoryView4.$el).append(this.categoryView5.$el), 
        console.log(this));
    }
