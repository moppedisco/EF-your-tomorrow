...
function($) {
    ...
    function bindActionButtons() {
        $(".article-start__btn").click(function(e) {
            ...
            var videoUrl = ($(this).attr("href"), $(this).attr("data-video")), text_button = $.trim($(this).text()), text = $(this).attr("data-text"), ulElement = $(this).closest("ul"), liElement = $(this).closest("li").index();
            ...
            4 === YT.app.active_section && $(".full-screen-section:eq(" + (YT.app.active_section + 1) + ")").find("h2 u").html($.trim(text_button)), 
            setTimeout(function() {
    ...
    function playPlaylistIndex(index) {
        ...
        curVideoPlayer.play(), playlist[index + 1] && (preVideoPlayer.style.zIndex = 0, 
