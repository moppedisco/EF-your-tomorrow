...
!function(window, undefined) {
    ...
    function bindActionButtons() {
        $(".article-start__btn").click(function(e) {
            $(this).attr("href");
            Modernizr.touch || YT.app.moveBGvideo(1), YT.app.goToSection(1, !0), e.preventDefault();
        }), $(".name-field__text").click(function() {
            setCaret();
            ...
            setTimeout(function() {
                Modernizr.touch || YT.app.moveBGvideo(1), YT.app.goToSection(1, !0);
    ...
    function goToSection(steps, animate, callback) {
        ...
        var current = pageSections[active_section].id, target = pageSections[active_section + steps].id;
        active_section += steps, animate ? $sectionContainer.transition({
            y: distanceScrolled + "%",
            easing: "custom-ease",
            duration: 800
        }, function() {
