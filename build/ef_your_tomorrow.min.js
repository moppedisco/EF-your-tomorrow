...
function($) {
    ...
    function init() {
        welcomeScreen(function() {
            YT.app.myAudioPlayer()[0].play(), YT.app.myAudioPlayer().animate({
                volume: .5
    ...
    function bindActionButtons() {
        $(".article-start__btn").click(function(e) {
            ...
            return $(this).hasClass("active") ? !1 : ("undefined" != typeof ga && ga("send", "event", "Button - Category" + YT.app.active_section, "click", "Clicked index: " + liElement + " - " + text), 
            ...
            $(".subtitles li:last-child").addClass(textPosition), 4 === YT.app.active_section && $(".full-screen-section:eq(" + (YT.app.active_section + 1) + ")").find("h2 u").html($.trim(text_button)), 
            setTimeout(function() {
                Modernizr.touch || YT.app.moveBGvideo(1), YT.app.goToSection(1, !0, function() {
    ...
    function initVideo(callback) {
        myPlayer = $(el_fullScreenVideo)[0], myPlayer.setAttribute("loop", "true"), adjustVideoPositioning(el_fullScreenVideo), 
        callback();
    }
    ...
    function bindActionButtons() {
        $(".button--play").click(function(e) {
            ...
            if ($(".name-field__inputarea").hasClass("ready")) {
                ...
                console.log("entered name"), "undefined" != typeof ga && ga("send", "event", "Name", "click", "Did enter name");
            } else console.log("NO name"), "undefined" != typeof ga && ga("send", "event", "Name", "click", "Did NOT enter name");
    ...
    var getShareLink = function(userName, selectedCatogories) {
        ...
        return Modernizr.csstransitions ? (console.log("base64"), window.location.host + window.Settings.VideoPageUrl + "?id=" + window.btoa(escape(serializedString))) : void 0;
    };
    return {
        init: init,
