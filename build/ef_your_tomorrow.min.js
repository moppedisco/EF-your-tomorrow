...
!function(window, undefined) {
    ...
    function bindScrollButtons() {
        $("#section-intro__btn").click(function(e) {
            ...
            selectedVideos.push(videoUrl), addLoadResources(videoUrl, "video"), $(".subtitles").append("<li>" + text + "</li>"), 
            setTimeout(function() {
                Modernizr.touch || moveBGvideo(scrollDirection), scrollToDiv(scrollDirection, target);
    ...
    var myPlayer, directionPosition = 0, scrollDirection = 1, $fullScreenImage = $(".full-screen-image"), fullScreenVideo = "#mainVideo", $sectionContainer = $(".body"), $window = $(window), mediaAspect = 16 / 9, selectedVideos = [], loader = new PxLoader(), pelle = 0, count = 0;
    return {
        init: init,
